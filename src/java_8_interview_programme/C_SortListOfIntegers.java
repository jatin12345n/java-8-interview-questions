...
//TODO .Write a program to sort a list og integers using the Stream API in Java 8.
public class C_SortListOfIntegers {
    ...
    public static void main(String[] args) {
        ...
        // in last we are using terminal operation .collect() which give use final result from stream
