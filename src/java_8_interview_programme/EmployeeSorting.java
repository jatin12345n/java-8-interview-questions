...
public class EmployeeSorting {
    ...
    public static void main(String[] args) {
        ...
        List<Employee> SortedEmployeeOnSalary = employeeList
        ...
        List<Employee> reverseSortedEmployeesOnSalary = employeeList.stream()
        ...
        System.out.println("Sorted employee based on names " + sortedEmployeeByName);
