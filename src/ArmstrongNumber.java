public class ArmstrongNumber {
    ...
    /*TODO n case of armstrong number of 3 digits, the sum of cubes of each digits is equal to the number itself. For example:
                                             //155 = 1*1*1 = 5*5*5 + 3*3*3  // 153 is an Armstrong number.*/

    public static void main(String[] args) {
        int number = 371, originalNumber, remainder, result = 0;
//TODO HERE WE TAKEN THESE VARIABLE TO STORE OUR RESULT , REMAINDER AND ORIGINAL NUMBER WHICH WE WILL USE FURTHER
